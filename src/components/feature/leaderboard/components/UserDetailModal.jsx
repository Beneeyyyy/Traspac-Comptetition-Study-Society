      ...
      <div className="relative bg-[#0A0A0B] border border-white/10 rounded-2xl w-full max-w-xl overflow-hidden">
        ...
        <div className="relative p-8 pb-6 border-b border-white/10">
          <div className="flex items-center gap-6">
            ...
            <div>
              ...
              <p className="text-white/60">{user.school}</p>
        ...
        <div className="px-8 py-6 border-b border-white/10">
          ...
          <p className="text-white/60 leading-relaxed">
            A dedicated student at {user.school} with a strong focus on {user.category}. 
            Based in {user.region}, they have completed {user.coursesCount} courses and invested {user.timeSpent} in learning. 
            Their commitment to academic excellence is reflected in their impressive achievement of {user.points.toLocaleString()} points.
          </p>
          <div className="mt-4 flex items-center gap-2">
            <div className="px-3 py-1 rounded-full bg-white/[0.03] border border-white/10">
              <span className="text-sm text-white/60">{user.category} Enthusiast</span>
            </div>
            <div className="px-3 py-1 rounded-full bg-white/[0.03] border border-white/10">
              <span className="text-sm text-white/60">{user.region} Region</span>
            </div>
            <div className="px-3 py-1 rounded-full bg-white/[0.03] border border-white/10">
              <span className="text-sm text-white/60">{user.coursesCount}+ Courses</span>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 gap-4 p-8">
          ...
          <div className="bg-white/[0.03] rounded-xl p-4">
            ...
            <p className="text-2xl font-bold text-blue-400">{user.timeSpent}</p>
          </div>
          ...
          <div className="bg-white/[0.03] rounded-xl p-4">
            ...
            <p className="text-2xl font-bold text-purple-400">{user.coursesCount}</p>
          </div>
          ...
          <div className="bg-white/[0.03] rounded-xl p-4">
            ...
            <p className="text-2xl font-bold text-blue-400">{user.region}</p>
          </div>
        </div>
